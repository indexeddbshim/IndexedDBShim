...
- `idbobjectstore_openKeyCursor.js`: seems to have its last test in a
    race condition or such to cause pass/fail results to vary
- `idbobjectstore-clear-exception-order.js`: Had been failing earlier
...
2. GETALL/GETALLKEYS WITH ENFORCE RANGE
...
IndexedDB Test counts:
    309 normal files (including 1 domstringlist file):
        270 are all good, 38 have at least some bad, 1 times out
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  ...
  'Pass': 1011, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 85,
  'Timeout': 1,
  'Not Run': 0,
