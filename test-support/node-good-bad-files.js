...
const goodBad = {
    ...
    goodFiles: [
        ...
        'idbcursor-continuePrimaryKey-exception-order.js',
        'idbcursor-continuePrimaryKey-exceptions.js',
        ...
        'idbcursor-iterating-update.js',
        'idbcursor-key.js',
        'idbcursor-primarykey.js',
        'idbcursor-request-source.js',
        ...
        'idbcursor_continue_delete_objectstore.js',
        ...
        'idbfactory-deleteDatabase-request-success.js',
        'idbfactory-open-error-properties.js',
        'idbfactory-open-request-error.js',
        'idbfactory-open-request-success.js',
        'idbfactory_cmp.js',
        'idbfactory_cmp2.js',
        'idbfactory_cmp3.js',
        'idbfactory_cmp4.js',
        ...
        'idbindex-objectStore-SameObject.js',
        'idbindex-query-exception-order.js',
        'idbindex-rename-abort.js',
        'idbindex-rename-errors.js',
        'idbindex-rename.js',
        'idbindex-request-source.js',
        'idbindex_count.js',
        'idbindex_count2.js',
        'idbindex_count3.js',
        'idbindex_count4.js',
        ...
        'idbobjectstore-index-finished.js',
        'idbobjectstore-query-exception-order.js',
        'idbobjectstore-rename-abort.js',
        'idbobjectstore-rename-errors.js',
        'idbobjectstore-rename-store.js',
        'idbobjectstore-request-source.js',
        'idbobjectstore-transaction-SameObject.js',
        ...
        'idbrequest_error.js',
        'idbrequest_result.js',
        'idbtransaction-db-SameObject.js',
        'idbtransaction-objectStore-exception-order.js',
        'idbtransaction-objectStore-finished.js',
        ...
        'keygenerator-explicit.js',
        'keygenerator-inject.js',
