...
IndexedDB Test counts:
    328 normal files (including 1 domstringlist file):
        321 are all good, 3 have some that are bad,
        4 have some that time out and 3 have some that do not run
...
*/
const goodBad = {
    excludedNormal: ['bindings-inject-key.js', 'keypath-exceptions.js', 'event-dispatch-active-flag.js', 'upgrade-transaction-deactivation-timing.js'],
