...
IndexedDB Test counts:
    346 normal files (including 1 domstringlist file):
        335 are all good, 7 have some that are bad,
        5 have some that time out and 4 have some that do not run
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1225, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 22,
  'Timeout': 5,
  'Not Run': 4,
...
const goodBad = {
    ...
    notRunning: ['idbfactory-deleteDatabase-opaque-origin.js', 'idbfactory-open-opaque-origin.js', 'interleaved-cursors.js', 'nested-cloning-large.js'],
    timeout: ['idbfactory-deleteDatabase-opaque-origin.js', 'idbfactory-open-opaque-origin.js', 'interleaved-cursors.js', 'nested-cloning-large.js', 'parallel-cursors-upgrade.js'],
    goodFiles: [
    ...
    badFiles: [
        'idb-binary-key-detached.js', 'interfaces.js', 'nested-cloning-large-multiple.js', 'nested-cloning-large.js', 'nested-cloning-small.js', 'transaction-deactivation-timing.js', 'wasm-module-value.js'
    ]
};
