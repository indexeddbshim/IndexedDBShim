...
IndexedDB Test counts:
    323 normal files (including 1 domstringlist file):
        312 are all good, 7 have some that are bad,
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1166, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 10,
  'Timeout': 4,
  'Not Run': 2,
...
const goodBad = {
    ...
    badFiles: [
        'idb-binary-key-detached.js', 'idbdatabase_close.js', 'idbdatabase_close2.js', 'interfaces.js', 'transaction-deactivation-timing.js', 'transaction-lifetime-blocked.js', 'transaction-lifetime.js'
    ]
};
