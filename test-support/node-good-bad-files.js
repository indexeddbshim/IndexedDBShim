...
IndexedDB Test counts:
    347 normal files (including 1 domstringlist file):
        339 are all good, 2 have some that are bad,
        6 have some that time out and 3 have some that do not run
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1095, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 5,
  'Timeout': 6,
  'Not Run': 3,
  'Total tests': 1109 (including 4 domstringlist tests but avoiding exclusions)
