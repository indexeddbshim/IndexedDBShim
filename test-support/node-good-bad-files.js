...
3. CLONING/PROTOTYPE CHAIN (May not be possible to truly fix in JS)
...
IndexedDB Test counts:
    323 normal files (including 1 domstringlist file):
        305 are all good, 14 have at least some bad, 4 time out, 2 do not run
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1135, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 41,
  'Timeout': 4,
  'Not Run': 2,
