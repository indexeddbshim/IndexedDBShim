...
IndexedDB Test counts:
    312 normal files (including 1 domstringlist file):
        277 are all good, 34 have at least some bad, 1 times out
    3 excluded files (uncaught exceptions during testing):
        `bindings-inject-key.js`, `keypath-exceptions`, `idb-binary-key-roundtrip.js`

Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):

  'Pass': 1048, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 80,
  'Timeout': 1,
  'Not Run': 0,
  'Total tests': 1129 (including 4 domstringlist tests but avoiding exclusions)
