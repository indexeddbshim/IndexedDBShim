...
goodBad.browser = {
    ...
    safari: {
        ...
        notRunning: ['idbobjectstore-rename-store.html', 'idbversionchangeevent.htm', 'interfaces.html', 'interfaces.worker.html', 'interleaved-cursors.html', 'keypath-exceptions.htm', 'name-scopes.html', 'open-request-queue.html', 'parallel-cursors-upgrade.html', 'upgrade-transaction-deactivation-timing.html'],
        badFiles: ['bindings-inject-key.html', 'fire-error-event-exception.html', 'fire-upgradeneeded-event-exception.html', 'idb-binary-key-detached.htm', 'idb_webworkers.htm', 'idbindex-query-exception-order.html', 'idbobjectstore-add-put-exception-order.html', 'idbobjectstore-clear-exception-order.html', 'idbobjectstore-delete-exception-order.html', 'idbobjectstore-index-finished.html', 'idbobjectstore-query-exception-order.html', 'idbtransaction-objectStore-finished.html', 'keypath-special-identifiers.htm', 'transaction-abort-generator-revert.html', 'transaction-deactivation-timing.html', 'transaction-lifetime.htm']
    },
    chrome: {
