...
- `large-nested-cloning.js` - See https://github.com/w3c/web-platform-tests/commit/a414c1dd8ea33b9884ea87d13bd493629b640b44
...
IndexedDB Test counts:
    335 normal files (including 1 domstringlist file):
        328 are all good, 4 have some that are bad,
        3 have some that time out and 2 have some that do not run
    4 excluded files with 16 tests (uncaught exceptions during testing):
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1197, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 15,
  'Timeout': 3,
  'Not Run': 2,
  'Total tests': 1217 (including 4 domstringlist tests but avoiding exclusions)
