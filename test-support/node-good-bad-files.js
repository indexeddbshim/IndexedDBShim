...
- `large-nested-cloning.js` - Excluded as causes some other tests not to be run; see https://github.com/w3c/web-platform-tests/commit/a414c1dd8ea33b9884ea87d13bd493629b640b44
...
IndexedDB Test counts:
    334 normal files (including 1 domstringlist file):
        327 are all good, 3 have some that are bad,
        4 have some that time out and 2 have some that do not run
    5 excluded files with 24 tests (uncaught exceptions during testing):
        `bindings-inject-key.js` (3 tests),
        `keypath-exceptions.js` (6 tests),
        `large-nested-cloning.js` (2 passing, 8 failing tests),
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1206, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 7,
  'Timeout': 4,
  'Not Run': 2,
  'Total tests': 1219 (including 4 domstringlist tests but avoiding exclusions)
