...
IndexedDB Test counts:
    309 normal files (including 1 domstringlist file):
        274 are all good, 34 have at least some bad, 1 times out
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  ...
  'Pass': 1017, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 79,
  'Timeout': 1,
  'Not Run': 0,
