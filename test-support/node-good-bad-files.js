...
IndexedDB Test counts:
    351 normal files (including 1 domstringlist file):
        333 are all good, 6 have some that are bad,
        13 have some that time out and 3 have some that do not run
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1093, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 8,
  'Timeout': 9,
  'Not Run': 4,
  'Total tests': 1114 (including 4 domstringlist tests but avoiding exclusions)
