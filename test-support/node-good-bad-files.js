...
IndexedDB Test counts:
    345 normal files (including 1 domstringlist file):
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1069, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 21,
  'Timeout': 7,
  'Not Run': 2,
  'Total tests': 1099 (including 4 domstringlist tests but avoiding exclusions)
