...
IndexedDB Test counts:
    357 normal files (including 1 domstringlist file):
        341 are all good, 11 have some that are bad,
...
const goodBad = {
    ...
    badFiles: [
        'bindings-inject-values-bypass-setters.js', 'get-databases.any.js', 'idb-binary-key-detached.js', 'idb-explicit-commit-throw.any.js', 'idb-explicit-commit.any.js', 'idbfactory-origin-isolation.js', 'idlharness.any.js', 'parallel-cursors-upgrade.js', 'structured-clone.any.js', 'transaction-deactivation-timing.js', 'transaction-relaxed-durability.tentative.any.js'
    ]
};
