...
IndexedDB Test counts:
    322 normal files (including 1 domstringlist file):
        291 are all good, 27 have at least some bad, 4 time out, 2 do not run
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  ...
  'Pass': 1106, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 64,
  'Timeout': 4,
  'Not Run': 2,
