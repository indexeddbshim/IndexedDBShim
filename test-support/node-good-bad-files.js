...
IndexedDB Test counts:
    320 normal files (including 1 domstringlist file):
        286 are all good, 30 have at least some bad, 3 time out, 2 do not run
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  ...
  'Timeout': 3,
  'Not Run': 2,
  'Total tests': 1171 (including 4 domstringlist tests but avoiding exclusions)
...
const goodBad = {
    ...
    timeout: ['idbfactory-deleteDatabase-opaque-origin.js', 'idbfactory-open-opaque-origin.js', 'open-request-queue.js'],
    goodFiles: [
