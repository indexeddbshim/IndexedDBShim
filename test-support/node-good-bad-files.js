...
const goodBad = {
    ...
    badFiles: [
        'bindings-inject-values-bypass-setters.js', 'blob-contenttype.any.js', 'blob-valid-after-deletion.any.js', 'blob-valid-before-commit.any.js', 'blob-composite-blob-reads.any.js', 'file_support.sub.js', 'get-databases.any.js', 'idb-binary-key-detached.js', 'idb-explicit-commit-throw.any.js', 'idb-explicit-commit-throw.any2.js', 'idb-explicit-commit.any.js', 'idb-explicit-commit.any2.js', 'idbfactory-origin-isolation.js', 'idlharness.any.js', 'key_invalid.js', 'structured-clone-transaction-state.any.js', 'structured-clone.any.js', 'transaction-deactivation-timing.js', 'transaction-relaxed-durability.tentative.any.js',
        'idbfactory-open-opaque-origin.js',
        'idbindex-cross-realm-methods.js',
        'idbobjectstore-cross-realm-methods.js',
