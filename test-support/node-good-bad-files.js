...
IndexedDB Test counts:
    323 normal files (including 1 domstringlist file):
        308 are all good, 11 have at least some bad, 4 time out, 2 do not run
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1146, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 30,
  'Timeout': 4,
  'Not Run': 2,
...
const goodBad = {
    ...
    badFiles: [
        'idb-binary-key-detached.js', 'idbdatabase_close.js', 'idbdatabase_close2.js', 'idbindex-rename-abort.js', 'idbindex-rename.js', 'idbobjectstore-rename-abort.js', 'idbobjectstore-rename-store.js', 'interfaces.js', 'transaction-deactivation-timing.js', 'transaction-lifetime-blocked.js', 'transaction-lifetime.js'
    ]
};
