...
goodBad.browser = {
    ...
    safari: {
        timeout: ['event-dispatch-active-flag.html', 'fire-success-event-exception.html', 'idbindex-multientry-big.htm'],
        notRunning: ['idbobjectstore-rename-store.html', 'idbobjectstore_createIndex13.htm', 'idbobjectstore_createIndex14-exception_order.htm', 'idbobjectstore_createIndex15-autoincrement.htm', 'idbobjectstore_createIndex2.htm', 'idbobjectstore_createIndex3-usable-right-away.htm', 'idbobjectstore_createIndex4-deleteIndex-event_order.htm', 'idbobjectstore_createIndex5-emptykeypath.htm', 'idbobjectstore_createIndex6-event_order.htm', 'idbobjectstore_createIndex7-event_order.htm', 'idbobjectstore_createIndex8-valid_keys.htm', 'idbobjectstore_openCursor_invalid.htm', 'idbobjectstore_openKeyCursor.htm', 'idbobjectstore_put.htm', 'idbobjectstore_put10.htm', 'idbobjectstore_put15.htm', 'idbobjectstore_put16.htm', 'idbobjectstore_put2.htm', 'idbobjectstore_put3.htm', 'idbobjectstore_put4.htm', 'idbobjectstore_put5.htm', 'idbtransaction.htm', 'idbtransaction_abort.htm', 'idbtransaction_objectStoreNames.html', 'idbversionchangeevent.htm', 'index_sort_order.htm', 'interfaces.html', 'interfaces.worker.html', 'interleaved-cursors.html', 'key-conversion-exceptions.htm', 'key_invalid.htm', 'key_valid.html', 'keygenerator-constrainterror.htm', 'keygenerator-explicit.html', 'keypath-exceptions.htm', 'keypath.htm', 'keypath_invalid.htm', 'keypath_maxsize.htm', 'list_ordering.htm', 'name-scopes.html', 'objectstore_keyorder.htm', 'open-request-queue.html', 'parallel-cursors-upgrade.html', 'request_bubble-and-capture.htm', 'string-list-ordering.htm', 'transaction-abort-generator-revert.html', 'transaction-abort-index-metadata-revert.html', 'transaction-abort-multiple-metadata-revert.html', 'transaction-abort-object-store-metadata-revert.html', 'transaction-abort-request-error.html', 'transaction-create_in_versionchange.htm', 'transaction-deactivation-timing.html', 'transaction-lifetime-blocked.htm', 'transaction-lifetime-empty.html', 'transaction-lifetime.htm', 'transaction-requestqueue.htm', 'transaction_bubble-and-capture.htm', 'upgrade-transaction-deactivation-timing.html', 'upgrade-transaction-lifecycle-backend-aborted.html', 'upgrade-transaction-lifecycle-committed.html', 'upgrade-transaction-lifecycle-user-aborted.html', 'value.htm', 'value_recursive.htm', 'writer-starvation.htm'],
        badFiles: ['bindings-inject-key.html', 'fire-error-event-exception.html', 'fire-upgradeneeded-event-exception.html', 'idb-binary-key-detached.htm', 'idb_webworkers.htm', 'idbindex-query-exception-order.html', 'idbobjectstore-add-put-exception-order.html', 'idbobjectstore-clear-exception-order.html', 'idbobjectstore-delete-exception-order.html', 'idbobjectstore-index-finished.html', 'idbobjectstore-query-exception-order.html', 'idbtransaction-objectStore-finished.html', 'keypath-special-identifiers.htm']
    },
    chrome: {
        ...
        badFiles: ['bindings-inject-key.html', 'clone-before-keypath-eval.html', 'error-attributes.html', 'event-dispatch-active-flag.html', 'fire-error-event-exception.html', 'fire-success-event-exception.html', 'fire-upgradeneeded-event-exception.html', 'idb-binary-key-detached.htm', 'idb-binary-key-roundtrip.htm', 'idbcursor-advance-exception-order.html', 'idbcursor-continuePrimaryKey.htm', 'idbcursor-delete-exception-order.htm', 'idbcursor-update-exception-order.htm', 'idbindex-getAllKeys-enforcerange.html', 'idbindex-query-exception-order.html', 'idbobjectstore-add-put-exception-order.html', 'idbobjectstore-clear-exception-order.html', 'idbobjectstore-delete-exception-order.html', 'idbobjectstore-getAll-enforcerange.html', 'idbobjectstore-getAllKeys-enforcerange.html', 'idbobjectstore-index-finished.html', 'idbobjectstore-query-exception-order.html', 'idbobjectstore_createIndex14-exception_order.htm', 'idbtransaction-objectStore-finished.html', 'interfaces.html', 'interfaces.worker.html', 'keypath-special-identifiers.htm', 'transaction-abort-generator-revert.html', 'transaction-abort-request-error.html', 'transaction-deactivation-timing.html', 'transaction-lifetime.htm', 'upgrade-transaction-deactivation-timing.html']
    }
};
