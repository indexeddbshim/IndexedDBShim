...
const goodBad = {
    ...
    timeout: ['idbfactory-deleteDatabase-opaque-origin.js', 'idbfactory-open-opaque-origin.js', 'interleaved-cursors.js', 'open-request-queue.js', 'parallel-cursors-upgrade.js'],
    goodFiles: [
