...
IndexedDB Test counts:
    323 normal files (including 1 domstringlist file):
        302 are all good, 17 have at least some bad, 4 time out, 2 do not run
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  ...
  'Pass': 1132, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 44,
  'Timeout': 4,
  'Not Run': 2,
