...
5. CLONING/PROTOTYPE CHAIN (May not be possible to truly fix in JS; if so, add to known issues)
    ...
    - `bindings-inject-keys-bypass-setters.js` - Failing
...
IndexedDB Test counts:
    ...
    6 excluded files with 16 tests (uncaught exceptions during testing):
        `bindings-inject-key.js` (3 tests),
        'bindings-inject-keys-bypass-setters.js' (1 test,
        'bindings-inject-values-bypass-setters.js' (1 test),
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1097, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 7,
  'Timeout': 6,
  'Not Run': 3,
  'Total tests': 1113 (including 4 domstringlist tests but avoiding exclusions)
...
*/
const goodBad = {
    excludedNormal: ['bindings-inject-key.js', 'event-dispatch-active-flag.js', 'keypath-exceptions.js', 'bindings-inject-keys-bypass-setters.js', 'bindings-inject-values-bypass-setters.js', 'upgrade-transaction-deactivation-timing.js'],
    ...
    timeout: ['idbfactory-databases-opaque-origin.js', 'idbfactory-deleteDatabase-opaque-origin.js', 'idbfactory-open-opaque-origin.js', 'idbfactory-origin-isolation.js', 'interleaved-cursors-large.js', 'interleaved-cursors-small.js'],
    goodFiles: [
    ...
    badFiles: [
        'idb-binary-key-detached.js', 'idlharness.any.js', 'parallel-cursors-upgrade.js', 'transaction-deactivation-timing.js'
    ]
};
