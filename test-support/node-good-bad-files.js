...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1227, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 23,
  'Timeout': 4,
  'Not Run': 2,
  'Total tests': 1256 (including 4 domstringlist tests but avoiding exclusions)
...
goodBad.browser = {
    ...
    safari: {
        ...
        notRunning: ['interfaces.html', 'interfaces.worker.html', 'interleaved-cursors-large.html', 'interleaved-cursors-small.html', 'keypath-exceptions.htm', 'upgrade-transaction-deactivation-timing.html'],
