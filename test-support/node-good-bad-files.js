...
goodBad.browser = {
    ...
    chrome: {
        notRunning: ['idbcursor-continuePrimaryKey-exception-order.htm', 'interleaved-cursors.html'],
        badFiles: ['fire-error-event-exception.html', 'fire-success-event-exception.html', 'fire-upgradeneeded-event-exception.html', 'idb-binary-key-detached.htm', 'idb-binary-key-roundtrip.htm', 'idb_binary_key_conversion.htm', 'idbcursor-continuePrimaryKey-exceptions.htm', 'idbcursor-continuePrimaryKey.htm', 'idbfactory_cmp3.htm', 'idbfactory_cmp4.htm', 'idbindex-rename-abort.html', 'idbindex-rename-errors.html', 'idbindex-rename.html', 'idbobjectstore-rename-abort.html', 'idbobjectstore-rename-errors.html', 'idbobjectstore-rename-store.html', 'idbobjectstore_createIndex15-autoincrement.htm', 'idbobjectstore_getKey.html', 'idbtransaction-objectStore-finished.html', 'interfaces.html', 'interfaces.worker.html', 'key-conversion-exceptions.htm', 'keygenerator-explicit.html']
    }
};
