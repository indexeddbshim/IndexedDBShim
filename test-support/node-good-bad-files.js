...
Besides the following tests which would otherwise fail if our tests did not override `setTimeout` to
...
IndexedDB Test counts:
    322 normal files (including 1 domstringlist file):
        298 are all good, 20 have at least some bad, 4 time out, 2 do not run
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  ...
  'Pass': 1121, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 50,
  'Timeout': 4,
  'Not Run': 2,
