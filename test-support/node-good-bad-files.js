...
IndexedDB Test counts:
    322 normal files (including 1 domstringlist file):
        289 are all good, 29 have at least some bad, 4 time out, 2 do not run
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  ...
  'Pass': 1105, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 66,
  'Timeout': 4,
  'Not Run': 2,
