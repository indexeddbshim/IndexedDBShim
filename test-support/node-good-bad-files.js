...
IndexedDB Test counts:
    323 normal files (including 1 domstringlist file):
        303 are all good, 16 have at least some bad, 4 time out, 2 do not run
...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1133, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 43,
  'Timeout': 4,
  'Not Run': 2,
