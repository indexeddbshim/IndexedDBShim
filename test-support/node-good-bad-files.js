...
Current IndexedDB (and domstringlist) test statuses (vmTimeout = 40000):
  'Pass': 1134, (including 4 domstringlist tests but avoiding exclusions)
  'Fail': 150, // 114 are from one structured cloning test and 12+1+1 from missing commit API
  'Timeout': 5,
  'Not Run': 4,
...
const goodBad = {
    ...
    badFiles: [
        'bindings-inject-values-bypass-setters.js', 'blob-contenttype.any.js', 'blob-valid-after-deletion.any.js', 'blob-valid-before-commit.any.js', 'file_support.sub.js', 'get-databases.any.js', 'idb-binary-key-detached.js', 'idb-explicit-commit-throw.any.js', 'idb-explicit-commit.any.js', 'idbfactory-origin-isolation.js', 'idlharness.any.js', 'key_invalid.js', 'parallel-cursors-upgrade.js', 'structured-clone-transaction-state.any.js', 'structured-clone.any.js', 'transaction-deactivation-timing.js', 'transaction-relaxed-durability.tentative.any.js'
    ]
};
