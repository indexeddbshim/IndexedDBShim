...
- `idbobjectstore_createIndex15-autoincrement.js`
...
IndexedDB Test counts:
    322 normal files (including 1 domstringlist file):
        286 are all good, 32 have at least some bad, 4 time out, 2 do not run
...
const goodBad = {
    ...
    badFiles: [
        'idb-binary-key-detached.js', 'idbcursor-advance-exception-order.js', 'idbdatabase-createObjectStore-exception-order.js', 'idbdatabase-deleteObjectStore-exception-order.js', 'idbdatabase-transaction-exception-order.js', 'idbdatabase_close.js', 'idbdatabase_close2.js', 'idbindex-query-exception-order.js', 'idbindex-rename-abort.js', 'idbindex-rename-errors.js', 'idbindex-rename.js', 'idbindex_get8.js', 'idbindex_getKey8.js', 'idbindex_openCursor3.js', 'idbindex_openKeyCursor4.js', 'idbobjectstore-add-put-exception-order.js', 'idbobjectstore-clear-exception-order.js', 'idbobjectstore-delete-exception-order.js', 'idbobjectstore-deleteIndex-exception-order.js', 'idbobjectstore-query-exception-order.js', 'idbobjectstore-rename-abort.js', 'idbobjectstore-rename-store.js', 'idbobjectstore_createIndex15-autoincrement.js', 'idbobjectstore_createIndex4-deleteIndex-event_order.js', 'interfaces.js', 'transaction-abort-index-metadata-revert.js', 'transaction-abort-multiple-metadata-revert.js', 'transaction-abort-object-store-metadata-revert.js', 'transaction-deactivation-timing.js', 'transaction-lifetime-blocked.js', 'transaction-lifetime.js', 'upgrade-transaction-lifecycle-user-aborted.js'
    ]
};
