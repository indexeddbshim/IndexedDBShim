...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        clean: {
            ...
            w3c: {
                src: ['D_db*', 'D_testdb-*', 'D_test-db*', 'D_about*', 'D_^I^D^B*', 'D_blank*', 'D_database_name*', 'D_idbtransaction*', 'D_x', 'D_y', 'D_webworker*']
            },
            w3cOld: {
        ...
        eslint: {
            files: ['src/**/*.js', 'tests-qunit/**/*.js', 'tests-mocha/**/*.js', 'test-support/node*.js', 'test-support/environment.js', 'test-support/custom-reporter.js', 'tet-support/webworker/*.js', 'Gruntfile.js'],
            options: {
                configFile: '.eslintrc'
            }
        },
