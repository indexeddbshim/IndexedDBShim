...
if (typeof process !== 'undefined' && process.env.npm_config_test) { // eslint-disable-line n/no-process-env -- Convenient
    ...
    tests = [
        ...
        ...(typeof process !== 'undefined' ? ['DOMException-spec.js', 'nodeWebSQL-config-spec.js', 'CFG-spec.js', 'Sca-spec.js', 'IDBFactory/deleteDatabase-fs-error-spec.js'] : []),
        ...
        'IDBFactory/sysdb-standard-driver-spec.js',
        'IDBFactory/sysdb-error-injection-spec.js',
