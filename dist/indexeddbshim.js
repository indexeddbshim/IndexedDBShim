...
(function (factory) {
  ...
  function getIsTrusted() {
    ...
    var _ev = /** @type {EventWithProps} */ /** @type {EventWithProps} */ev.get(this);
  ...
  var ShimEventProto = /** @type {Record<PropertyKey, unknown>} */ /** @type {unknown} */ShimEvent.prototype;
  ...
  var ShimCustomEventProto = /** @type {Record<PropertyKey, unknown>} */ /** @type {unknown} */ShimCustomEvent.prototype;
  /**
   * @param {string} type
   * @param {boolean} [bubbles]
   * @param {boolean} [cancelable]
  ...
  function createEvent(type, debug, evInit) {
    ...
    var ev = /** @type {EventFull} */new ShimEvent(type, evInit);
    ev.debug = debug;
    return ev;
  }
  ...
  readonlyProperties$7.forEach(function (prop) {
    ...
    var o = _defineAccessor("get", {}, prop, function () {
      ...
      var me = /** @type {IDBVersionChangeEventFull} */ /** @type {unknown} */this;
  ...
  IDBRequest.__super = function IDBRequest() {
    ...
    defineReadonlyProperties(this, readonlyProperties$6, {
      readyState: {
         ...
         */
        get readyState() {
          var me = /** @type {IDBRequestFull} */ /** @type {unknown} */this;
  ...
  function hasConstructorOf(r, n) {
    ...
    var o = t(r);
    if (!o) return null === n;
    var a = e(o, "constructor") && o.constructor;
  ...
  function setAtKeyPath(t, r, n, o) {
    ...
    var a = t,
      s = r;
    for (;;) {
      if (!a || "object" != _typeof(a)) throw new TypeError("Unexpected non-object type");
      var _r = s.indexOf("."),
        _i = unescapeKeyPathComponent(-1 === _r ? s : s.slice(0, _r));
      if ("__proto__" === _i) throw new TypeError("Invalid property");
      if (-1 === _r) return a[_i] = n, t;
      if (!e(a, _i)) throw new TypeError("Invalid property");
      a = a[_i], s = s.slice(_r + 1);
    }
  }
  ...
  var s = ["asyncIterator", "hasInstance", "isConcatSpreadable", "iterator", "match", "matchAll", "replace", "search", "species", "split", "toPrimitive", "toStringTag", "unscopables"];
  ...
  var Typeson = /*#__PURE__*/function () {
    function Typeson(e) {
      ...
      var t = e === null || e === void 0 ? void 0 : e.symbols;
      t && Object.entries(t).forEach(function (_ref) {
        var _ref2 = _slicedToArray(_ref, 2),
          e = _ref2[0],
          t = _ref2[1];
        if ("symbol" != _typeof(t)) throw new TypeError("Non-symbol value supplied for `symbols` entry: " + e);
        _this2.symbolsByName[e] = t, _this2.symbolsByValue.set(t, e);
      });
    }
    return _createClass(Typeson, [{
      ...
      key: "encapsulate",
      value: function encapsulate(e, t, i) {
        var _this3 = this;
        var c = _objectSpread2(_objectSpread2({
            sync: true
          }, this.options), i),
          l = c.sync,
          u = {},
          ...
          _adaptBuiltinStateObjectProperties = function _adaptBuiltinStateObjectProperties(e, t, r) {
            ...
            r(), a.forEach(function (t, r) {
              e[t] = n[r];
            });
          },
          _encapsulate2 = function _encapsulate(e, t, a, i, l, m, d) {
            var g,
              v = {};
            var w = h ? function (r) {
                var _ref4;
                var n = (_ref4 = d !== null && d !== void 0 ? d : i.type) !== null && _ref4 !== void 0 ? _ref4 : getJSONType(t);
                h(Object.assign(r !== null && r !== void 0 ? r : v, {
                  keypath: e,
                  value: t,
                  cyclic: a,
                  stateObj: i,
              ...
              getEncapsulatedValue = function getEncapsulatedValue(e, t, r) {
                try {
                  return {
                    value: _encapsulate2(e, t[r], Boolean(a), i, l, m)
                  };
                } catch (n) {
                  var _ref5;
                  if (!b) throw n;
                  var _o2 = (_ref5 = d !== null && d !== void 0 ? d : i.type) !== null && _ref5 !== void 0 ? _ref5 : getJSONType(t),
                    _a = b({
                      keypath: e,
                      error: n,
                      parent: t,
            ...
            if (["string", "boolean", "number", "undefined"].includes(_typeof(t))) return void 0 === t || t === 1 / 0 || 0 === t || t === -1 / 0 || Number.isNaN(t) ? (g = i.replaced ? t : replace(e, t, i, l, false, m, w), g !== t && (v = {
              replaced: g
            })) : g = t, w && w(), g;
            ...
            var O = isPlainObject(t),
              A = o(t),
              T = (O || A) && (!_this3.plainObjectReplacers.length || i.replaced) || i.iterateIn ? t : replace(e, t, i, l, O || A, null, w);
            var S;
            if (T !== t ? (g = T, v = {
              replaced: T
              ...
              clone: S
            }) : !O && ("object" != _typeof(t) || "toJSON" in t || hasConstructorOf(t, TypesonPromise) || hasConstructorOf(t, Promise) || hasConstructorOf(t, ArrayBuffer)) && "object" !== i.iterateIn ? g = t : (S = {}, i.addLength && (S.length = t.length), v = {
              clone: S
            }), w && w(), c.iterateNone) return S !== null && S !== void 0 ? S : g;
            if (!S) return g;
            if (i.iterateIn) {
              var _loop = function _loop(_r3) {
                ...
                _adaptBuiltinStateObjectProperties(i, o, function () {
                  var n = e + (e ? "." : "") + escapeKeyPathComponent(_r3),
                    o = getEncapsulatedValue(n, t, _r3),
                    s = o && o.value;
                  hasConstructorOf(s, TypesonPromise) ? l.push([n, s, Boolean(a), i, S, _r3, i.type]) : o && (void 0 !== s || "substitute" in o) && setOwnEnumerable(S, _r3, s);
                });
              };
              for (var _r3 in t) {
                _loop(_r3);
              ...
              _adaptBuiltinStateObjectProperties(i, {
                ...
                var e = getEncapsulatedValue(f, m, "value"),
                  t = e && e.value;
            ...
            if (i.iterateUnsetNumeric) {
              ...
              var _loop2 = function _loop2(_n) {
                ...
                _adaptBuiltinStateObjectProperties(i, {
                  ...
                  var e = _encapsulate2(r, void 0, Boolean(a), i, l, m);
                  hasConstructorOf(e, TypesonPromise) ? l.push([r, e, Boolean(a), i, S, _n, i.type]) : void 0 !== e && setOwnEnumerable(S, _n, e);
                });
              };
          ...
          replace = function replace(e, t, r, n, o, a, s) {
            var i = o ? _this3.plainObjectReplacers : _this3.nonplainObjectReplacers;
            var c = i.length;
            for (; c--;) {
              var _o3 = i[c];
              if (_o3.test(t, r)) {
                ...
                if (Object.assign(r, {
                  type: _i2,
                  replaced: true
                }), (l || !_o3.replaceAsync) && !_o3.replace) return s && s({
                  typeDetected: true
                }), _encapsulate2(e, t, d && "readonly", r, n, a, _i2);
                var _c = void 0;
                if (s && s({
                  replacing: true
                }), l || !_o3.replaceAsync) {
                  ...
                  _c = _o3.replace(t, r);
                } else _c = _o3.replaceAsync(t, r);
                return _encapsulate2(e, _c, d && "readonly", r, n, a, _i2);
              }
            }
            return t;
          },
          g = _encapsulate2("", e, d, t !== null && t !== void 0 ? t : {}, m);
        if (m.length) return l && c.throwOnBadSyncType ? function () {
          throw new TypeError("Sync method requested but async result obtained");
        }() : Promise.resolve(_checkPromises(g, m)).then(finish);
      ...
      value: function revive(e, t) {
        var _this4 = this;
        var a = _objectSpread2(_objectSpread2({
            sync: true
          }, this.options), t),
          i = a.sync;
        ...
        var reHomeSymbolKeys = function reHomeSymbolKeys(e) {
            ...
            t && (Object.entries(t).forEach(function (_ref8) {
              var _ref9 = _slicedToArray(_ref8, 2),
                t = _ref9[0],
                r = _ref9[1];
              var o = getByKeyPath(e, t);
              isObject(o) && r.forEach(function (e) {
                if (!n(e, "value")) return;
                var t = function resolveSymbolFromIdentity(e, t) {
                    if ("for" in e) return Symbol.for(e.for);
                    if ("wellKnown" in e) {
                      var _t6 = s.find(function (t) {
                        return t === e.wellKnown;
                      });
                      if (!_t6) throw new Error("Unknown well-known Symbol: " + e.wellKnown);
                      return Symbol[_t6];
                    }
                    if (!n(t, e.registered)) throw new Error("Unregistered symbol: " + e.registered);
                    return t[e.registered];
                  }(e.key, _this4.symbolsByName),
                  r = checkUndefined(e.value);
                e.descriptor ? Object.defineProperty(o, t, _objectSpread2(_objectSpread2({
                  configurable: true,
                  enumerable: true,
                  writable: true
                }, e.descriptor), {}, {
          ...
          h = function () {
            ...
            var t = [];
            if (Object.entries(c).forEach(function (_ref0) {
              var _ref1 = _slicedToArray(_ref0, 2),
                e = _ref1[0],
                r = _ref1[1];
              "#" !== r && [].concat(r).forEach(function (r) {
                var _this4$revivers$r;
                var _ref10 = (_this4$revivers$r = _this4.revivers[r]) !== null && _this4$revivers$r !== void 0 ? _this4$revivers$r : [null, {}],
            ...
            }), t.length) return t.sort(nestedPathsFirst), t.reduce(function reducer(t, _ref12) {
              var r = _ref12.keypath,
                n = _ref12.type;
              ...
              var a = setAtKeyPath(e, r, o);
              a === o && (e = a);
            }, void 0);
          }();
        var b;
        return hasConstructorOf(h, TypesonPromise) ? b = h.then(function () {
          return e;
          ...
          if (h || isPlainObject(t)) {
            ...
            for (r(t).forEach(function (r) {
              var n = _revive(e + (e ? "." : "") + escapeKeyPathComponent(r), t[r], a !== null && a !== void 0 ? a : _o4, _o4, r),
                set = function set(e) {
                  return hasConstructorOf(e, Undefined) ? setOwnEnumerable(_o4, r, void 0) : void 0 !== e && setOwnEnumerable(_o4, r, e), e;
                };
              hasConstructorOf(n, TypesonPromise) ? d.push(n.then(function (e) {
                return set(e);
              })) : set(n);
            }), t = _o4; y.length;) {
          ...
          return !i && d.length > u ? TypesonPromise.all(d.slice(u)).then(function () {
            return applyType(t);
          }) : applyType(t);
        }("", e, null), d.length && (b = TypesonPromise.resolve(b).then(function (e) {
          return TypesonPromise.all([e].concat(d));
        }).then(function (_ref13) {
          var _ref14 = _slicedToArray(_ref13, 1),
            e = _ref14[0];
          return e;
        }))), l && (isThenable(b) ? b = b.then(function (e) {
          return reHomeSymbolKeys(e), e;
        }) : reHomeSymbolKeys(b)), isThenable(b) ? i && a.throwOnBadSyncType ? function () {
          throw new TypeError("Sync method requested but async result obtained");
        }() : hasConstructorOf(b, TypesonPromise) ? b.p.then(checkUndefined) : b : !i && a.throwOnBadSyncType ? function () {
        ...
        var n = t !== null && t !== void 0 ? t : {},
          _reg = function reg(e) {
            o(e) ? e.forEach(function (e) {
              ...
              var r = e[t];
              if ([_this5.plainObjectReplacers, _this5.nonplainObjectReplacers].forEach(function (e) {
                var r = e.findIndex(function (e) {
                  return e.type === t;
                });
                -1 !== r && e.splice(r, 1);
              }), delete _this5.revivers[t], delete _this5.types[t], "function" == typeof r) {
                var _e4 = r;
                r = {
              ...
              var s = "number" == typeof n.fallback ? n.fallback : n.fallback ? 0 : 1 / 0;
              if (r.testPlainObjects ? _this5.plainObjectReplacers.splice(s, 0, a) : _this5.nonplainObjectReplacers.splice(s, 0, a), r.revive || r.reviveAsync) {
                var _e6 = {};
                r.revive && (_e6.revive = r.revive.bind(r)), r.reviveAsync && (_e6.reviveAsync = r.reviveAsync.bind(r)), _this5.revivers[t] = [_e6, {
  ...
  var f = {
    ...
    m = {
      audiodata: {
        test: function test(e) {
          return "AudioData" === toStringTag(e);
        },
        replace: function replace(e) {
          var t = e.format,
            r = e.sampleRate,
        ...
        revive: function revive(_ref15) {
          var e = _ref15.format,
            t = _ref15.sampleRate,
            r = _ref15.numberOfFrames,
            n = _ref15.numberOfChannels,
            o = _ref15.timestamp,
            a = _ref15.data;
  ...
  function string2arraybuffer(e) {
    ...
    for (var _r10 = 0; _r10 < e.length; _r10++) t[_r10] = e.charCodeAt(_r10);
    return t.buffer;
  }
  var b = {
    blob: {
  ...
  var w = {
      cryptokey: {
        ...
        replaceAsync: function replaceAsync(e) {
          return new TypesonPromise(/*#__PURE__*/function () {
            var _ref16 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(t, r) {
              var n, _t1;
              return _regenerator().w(function (_context3) {
                while (1) switch (_context3.p = _context3.n) {
                  ...
                  case 2:
                    _context3.p = 2;
                    _t1 = _context3.v;
                    return _context3.a(2, void r(_t1));
                  case 3:
                    t({
                      jwk: n,
    ...
    O = {
      dataview: {
        ...
        replace: function replace(_ref17, n) {
          var e = _ref17.buffer,
            t = _ref17.byteOffset,
            r = _ref17.byteLength;
          n.buffers || (n.buffers = []);
  ...
  var x = {
    ...
    I = {
      error: {
        ...
        replace: function replace(_ref24) {
          var e = _ref24.name,
            t = _ref24.message,
            r = _ref24.cause,
            n = _ref24.stack,
  ...
  function create$2(e) {
    B[e.name.toLowerCase()] = {
      ...
      replace: function replace(_ref25) {
        var e = _ref25.name,
          t = _ref25.message,
          r = _ref25.cause,
          n = _ref25.stack,
  ...
  var C = {
      file: {
        ...
        revive: function revive(_ref26) {
          var e = _ref26.name,
            t = _ref26.type,
            r = _ref26.stringContents,
            n = _ref26.lastModified;
    ...
    U = {
      ...
      filelist: {
        ...
        replace: function replace(e) {
          var t = [];
          for (var _r11 = 0; _r11 < e.length; _r11++) t[_r11] = e.item(_r11);
          return t;
        },
        revive: function revive(e) {
    ...
    k = {
      imagebitmap: {
        test: function test(e) {
          return "ImageBitmap" === toStringTag(e);
        },
        replace: function replace(e) {
    ...
    R = {
      imagedata: {
        ...
        replace: function replace(e) {
          var t = "Float16Array" === toStringTag(e.data) ? "rgba-float16" : "rgba-unorm8";
          return {
    ...
    ae = [{
      arrayNonindexKeys: {
        ...
        revive: function revive(e) {
          ...
          var t = [];
          return Object.entries(e).forEach(function (_ref37) {
  ...
  var origFileList = specSet && !Array.isArray(specSet) && 'filelist' in specSet ? specSet.filelist
  /* c8 ignore next -- Defensive fallback if typeson-registry's `filelist` preset entry ever goes missing */ : undefined;
  var origTest = origFileList && _typeof(origFileList) === 'object' && 'test' in origFileList && typeof origFileList.test === 'function' ? origFileList.test
  /* c8 ignore next -- Defensive fallback if typeson-registry's `filelist.test` ever goes missing */ : undefined;
  var origRevive = origFileList && _typeof(origFileList) === 'object' && 'revive' in origFileList && typeof origFileList.revive === 'function' ? origFileList.revive
  ...
  var typeson = new Typeson().register([fe, /* c8 ignore next -- Defensive fallback if typeson-registry's `filelist` preset entry ever goes missing */
  customFileList ? {
          ...
          tx.executeSql('SELECT "key", "value" FROM ' + escapeStoreNameForSQL(storeName), [], function (tx, data) {
            ...
            function addIndexEntry(i) {
              if (i < data.rows.length) {
                try {
                  var row = /** @type {{key: string, value: string}} */data.rows.item(i);
                  var value = decode(unescapeSQLiteResponse(row.value));
  ...
  function executeFetchIndexData(count, unboundedDisallowed, index, hasKey, range, opType, multiChecks, sql, sqlValues, tx, args, success, error) {
    ...
    tx.executeSql(sql.join(' '), sqlValues, function (tx, data) {
      ...
      if (index.multiEntry) {
        ...
        var _loop = function _loop() {
            var row = /** @type {{key: string, value: string, [k: string]: string}} */data.rows.item(i);
        ...
        for (var _i = 0; _i < data.rows.length; _i++) {
          var record = /** @type {{key: string, value: string}} */data.rows.item(_i);
          if (record) {
            records.push(decode$1(record));
          }
        }
  ...
  IDBObjectStore.__deleteObjectStore = function (db, store) {
    ...
    var transaction = /** @type {import('./IDBTransaction.js').IDBTransactionFull} */
    db.__versionTransaction;
    var storeHandle = transaction.__storeHandles[store.__currentName];
    if (storeHandle) {
  ...
  IDBDatabase.__createInstance = function (db, name, oldVersion, version, storeProperties) {
    ...
    function IDBDatabase() {
      ...
      var itemCopy = /** @type {IDBObjectStoreProperties} */{};
      var _loop = function _loop() {
        var item = /** @type {{name: string, keyPath: string, autoInc: string, indexList: string}} */storeProperties.rows.item(i);
  ...
  IDBDatabase.prototype.__forceClose = function (msg) {
    ...
    var transactions = me.__transactions;
    me.close();
  ...
  var sysdbMemoryDatabaseSetting;
  var nameCounter = 0;
      ...
      createSysDB(me.__openDatabase, function () {
        ...
        sysdb.readTransaction(function (sysReadTx) {
          sysReadTx.executeSql('SELECT "version" FROM dbVersions WHERE "name" = ?', [sqlSafeName], function (sysReadTx, data) {
            ...
            var _data$rows$item = /** @type {{version: Integer}} */data.rows.item(0);
  ...
  IDBFactory.prototype.databases = function () {
    ...
    return new Promise(function (resolve, reject) {
      ...
      function dbGetDatabaseNamesError(tx, err) {
        ...
        var er = err ? webSQLErrback(/** @type {(Error & {code?: number})} */err) : tx;
        calledDbCreateError = true;
        reject(er);
        return false;
      }
  ...
  IDBCursor.prototype.__findMultiEntry = function (key, primaryKey, tx, success, error) {
    ...
    function runQuery() {
      ...
      tx.executeSql(sqlStr, sqlValues, function (tx, data) {
        ...
        var lastRawRow = /** @type {RowItemNonNull} */data.rows.item(data.rows.length - 1);
  ...
  function parseGetAllArgs(args) {
    var arg0 = args[0];
    if (isObj(arg0) && !Array.isArray(arg0) && !isDate(arg0) && !isBinary(arg0) && !('upper' in arg0 && 'lowerOpen' in arg0 && typeof arg0.lowerOpen === 'boolean') // IDBKeyRange-like
    ) {
  ...
  /** @type {unknown} */typeof window !== 'undefined' ? window : self; // For Web Workers
  setGlobalVars();
