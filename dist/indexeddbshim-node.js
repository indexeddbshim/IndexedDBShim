...
},{"./CFG":5}],7:[function(require,module,exports){
"use strict";
...
},{"./util":25,"eventtargeter":1}],9:[function(require,module,exports){
"use strict";
...
},{"./CFG":5,"./DOMException":6,"./IDBFactory":11,"./IDBIndex":12,"./IDBKeyRange":13,"./IDBObjectStore":14,"./IDBRequest":15,"./IDBTransaction":16,"./Key":18,"./Sca":19,"./util":25}],10:[function(require,module,exports){
"use strict";
...
},{"./DOMException":6,"./DOMStringList":7,"./Event":8,"./IDBObjectStore":14,"./IDBTransaction":16,"./util":25,"eventtargeter":1}],11:[function(require,module,exports){
"use strict";
...
function cleanupDatabaseResources(__openDatabase, name, escapedDatabaseName, databaseDeleted, dbError) {
  ...
  if (_CFG.default.deleteDatabaseFiles !== false && {}.toString.call(process) === '[object process]') {
    require('fs').unlink(_path.default.join(_CFG.default.databaseBasePath || '', escapedDatabaseName), err => {
  ...
  createSysDB(me.__openDatabase, function () {
    sysdb.readTransaction(function (sysReadTx) {
      sysReadTx.executeSql('SELECT "name" FROM dbVersions', [], function (sysReadTx, data) {
        const dbNames = _DOMStringList.default.__createInstance();
...
},{"./CFG":5,"./DOMException":6,"./DOMStringList":7,"./Event":8,"./IDBDatabase":10,"./IDBRequest":15,"./IDBTransaction":16,"./IDBVersionChangeEvent":17,"./Key":18,"./cmp":20,"./util":25,"fs":undefined,"path":undefined,"sync-promise":2}],12:[function(require,module,exports){
"use strict";
...
},{"./CFG":5,"./DOMException":6,"./IDBCursor":9,"./IDBKeyRange":13,"./IDBObjectStore":14,"./IDBTransaction":16,"./Key":18,"./Sca":19,"./util":25,"sync-promise":2}],13:[function(require,module,exports){
"use strict";
...
},{"./DOMException":6,"./Key":18,"./util":25}],14:[function(require,module,exports){
"use strict";
...
IDBObjectStore.prototype.__insertData = function (tx, encoded, value, clonedKeyOrCurrentNumber, oldCn, success, error) {
  ...
  _syncPromise.default.all(indexPromises).then(() => {
...
},{"./CFG":5,"./DOMException":6,"./DOMStringList":7,"./IDBCursor":9,"./IDBIndex":12,"./IDBKeyRange":13,"./IDBTransaction":16,"./Key":18,"./Sca":19,"./util":25,"sync-promise":2}],15:[function(require,module,exports){
"use strict";
...
},{"./DOMException":6,"./util":25,"eventtargeter":1}],16:[function(require,module,exports){
"use strict";
...
},{"./CFG":5,"./DOMException":6,"./Event":8,"./IDBObjectStore":14,"./IDBRequest":15,"./util":25,"eventtargeter":1,"sync-promise":2}],17:[function(require,module,exports){
"use strict";
...
},{"./Event":8,"./util":25}],18:[function(require,module,exports){
"use strict";
...
},{"./CFG":5,"./DOMException":6,"./cmp":20,"./util":25}],19:[function(require,module,exports){
"use strict";
...
const structuredCloning = _structuredCloningThrowing.default;
...
const typeson = new _typeson.default().register(structuredCloning); // We are keeping the callback approach for now in case we wish to reexpose Blob, File, FileList
...
},{"./DOMException":6,"typeson":4,"typeson-registry/dist/presets/structured-cloning-throwing":3}],20:[function(require,module,exports){
"use strict";
...
},{"./CFG":5,"./Key":18}],21:[function(require,module,exports){
"use strict";
...
},{"./CFG":5,"./nodeWebSQL":22,"./setGlobalVars":23}],22:[function(require,module,exports){
"use strict";
...
},{"./CFG":5,"websql/custom":undefined,"websql/lib/sqlite/SQLiteDatabase":undefined}],23:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./CFG":5,"./DOMException":6,"./IDBCursor":9,"./IDBDatabase":10,"./IDBFactory":11,"./IDBIndex":12,"./IDBKeyRange":13,"./IDBObjectStore":14,"./IDBRequest":15,"./IDBTransaction":16,"./IDBVersionChangeEvent":17,"eventtargeter":1}],24:[function(require,module,exports){
"use strict";
